...
//    public static final String FROM_BUS = "firstlocation";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items1 = new String[]{"FROM", "guindy", "adayar", "Tnagar", "thambaram", "Besant nagar", "poonamallee", "porur"};
        ArrayAdapter<String> adapter1 = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, items1);
        dropdown1.setAdapter(adapter1);

        //To
        Spinner dropdown2 = findViewById(R.id.spinner2);
        String[] items2 = new String[]{"TO", "guindy", "adayar", "Tnagar", "thambaram", "Besant nagar", "poonamallee", "porur"};
